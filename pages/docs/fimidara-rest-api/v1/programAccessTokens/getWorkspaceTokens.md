---
title: Get Workspace Program Access Tokens Endpoint
description: Get workspace program access tokens endpoint.
---

# {% $markdoc.frontmatter.title %}
## `/v1/programAccessTokens/getWorkspaceTokens` — `post`
...
| Field | Type | Description |
| - | - | - |
|`tokens`|`array` of `object`|See below for `ProgramAccessToken`'s object fields.  undefined|
